  ...
  <div class="new-content">
    <div class="new-content-nav">
      <div class="new-content-userinfo">
        <div class="new-content-headimg">
          <img
            :src="patientInfo.sex?'../../../static/assets/img/bingNan.png':'../../../static/assets/img/bingNv.png'"
            alt
          >
        </div>
      ...
      <div class="new-content-content">
        <div
          class="new-content-content-item"
    ...
    <div class="new-content-body">
      <div class="new-content-body-nav">
        <div
          class="new-content-body-nav-item"
...
export default {
  ...
  computed: {
    ...
    showChildItem() {
      return this.patientListInfo.list[this.nowNav]
        ? this.patientListInfo.list[this.nowNav].childModules[
            this.patientListInfo.list[this.nowNav].showChildModuleIndex
          ].code
        : ''
    },
    showChildItemData() {
  ...
  methods: {
    ...
    async getEMRList() {
      ...
      sessionStorage.getItem('showPatientList') === 'false'
        ? (ajaxOption.familyMemberId = this.$route.query.id)
        : (ajaxOption.familyMemberId = this.inData.id)
      // if(sessionStorage.getItem('showPatientList') === 'false')return;//新加功能
    ...
    async getEMRInRecord(id, index) {
      ...
      if (res.data && res.data.errCode === 0) {
        this.patientListInfo.list[index].childModules[0].time =
          res.data.body.recordDtime
        this.patientListInfo.list[index].childModules[0].data =
          res.data.body.contents
        this.patientListInfo.list[index].childModules[0].recordName =
          res.data.body.recordName //记录医生
        this.patientListInfo.list[index].childModules[0].inSno =
          res.data.body.inSno //住院流水号
    ...
    async getEMRFirstCourse(id, index) {
      ...
      if (res.data && res.data.errCode === 0) {
        this.patientListInfo.list[index].childModules[1].time =
          res.data.body[0].recordDtime
        this.patientListInfo.list[index].childModules[1].data =
          res.data.body[0].contents
        this.patientListInfo.list[index].childModules[1].recordName =
          res.data.body[0].recordName //记录医生
        this.patientListInfo.list[index].childModules[1].inSno =
          res.data.body[0].inSno //住院流水号
        this.patientListInfo = Object.assign({}, this.patientListInfo)
      } else {
        this.$notify({
          title: '首次病程记录获取失败',
    ...
    async getEMREverydayCourse(id, index) {
      ...
      if (res.data && res.data.errCode === 0) {
        this.patientListInfo.list[index].childModules[2].time =
          res.data.body[0].recordDtime
        this.patientListInfo.list[index].childModules[2].data =
          res.data.body[0].contents
        this.patientListInfo.list[index].childModules[2].recordName =
          res.data.body[0].recordName //记录医生
        this.patientListInfo.list[index].childModules[2].inSno =
          res.data.body[0].inSno //住院流水号
        this.patientListInfo = Object.assign({}, this.patientListInfo)
      } else {
        this.$notify({
    ...
    async getEMRLeaveHospital(id, index) {
      ...
      if (res.data && res.data.errCode === 0) {
        this.patientListInfo.list[index].childModules[3].time =
          res.data.body[0].recordDtime
        this.patientListInfo.list[index].childModules[3].data =
          res.data.body[0].contents
        this.patientListInfo.list[index].childModules[3].recordName =
          res.data.body[0].recordName //记录医生
        this.patientListInfo.list[index].childModules[3].inSno =
          res.data.body[0].inSno //住院流水号
        this.patientListInfo = Object.assign({}, this.patientListInfo)
      } else {
        this.$notify({
