<!-- 门诊处方 -->
<template>
	<div class="prescription" style="display: flex;flex-wrap: wrap;margin: 10px;">
		<viewer :images='inData'>
			<img :src=o title="处方单" v-for='(o,i) in inData'
				style='width:250px; height:250px;border: 1px solid #d8d8d8;margin: 10px;'>
		</viewer>
	</div>
</template>
