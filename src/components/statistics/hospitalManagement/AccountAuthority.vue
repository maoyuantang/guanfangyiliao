            ...
            <tbody class="account-authority-tbody">
              <tr v-for="(item,index) in ourStaff.ourStaffUser.list" :key="index">
                ...
                <th>
                  ...
                  <el-button type="danger" size="mini" plain @click='deleteItem(item,index)'>删除</el-button>
                </th>
              </tr>
            </tbody>
          </table>
    ...
    >
      <div class="ourStaf-alert">
        ...
        <div class="ourStaf-alert-item-text">
          <div class="ourStaf-alert-item-text-ch">
            <span>账号:</span>
            <el-input placeholder="请输入内容" v-model="ourStafAlert.data.account" size="mini" clearable :disabled="ourStafAlert.type!==0"></el-input>
            <i class="iconfont ourStaf-alert-icon">&#xe7b0;</i>
          </div>
          <div class="ourStaf-alert-item-text-ch">
            <span>密码:</span>
