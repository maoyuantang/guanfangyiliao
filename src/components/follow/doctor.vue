<template>
    <div class="followUp">
        ...
        <div v-if="followTableVisible">
            <el-dialog class="evaluateBox addFollowBox addFollowBoxFollow" title=" " :visible.sync="followTableVisible"
                width="602px" hight="356px" center>
                                        ...
                                        <div class="DistanceFirst">
                                            <el-form-item label=" ">
                                                <el-select v-model="text.calcVal" placeholder=" ">
                                                    <el-option v-for="(text,index) in 21" :label="text" :value="text"
                                                        :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label=" ">
                                ...
                                <ul class="questBox">
                                    ...
                                    <li v-for="(otext,oindex) in text.contentModels" :key="oindex">
                                        ...
                                        <div v-else>
                                            ...
                                            <span @click="deleteQuest(index,oindex)"
                                                class="questDelete questDeleteSend">
                                ...
                                <div class="addFollowBtn" v-show="addFollowBtnVis">
                                    ...
                                    <div>
                                        ...
                                        <span @click="deleteFollowTimeList(index)">
                                            <span class="questDelete"> <img
                                                    src="../../assets/img/addFollowDelete.png" /> </span>
                                            删除此项</span>
                                    </div>
                                </div>
        ...
        <div v-if="QuestTableVisible">
            <el-dialog class="evaluateBox addQuestBox " title=" " :visible.sync="QuestTableVisible" width="717px"
                hight="356px" center>
                <el-form ref="form" :model="addQuestData" label-width="80px" style="height: 600px; overflow: auto;">
                    ...
                    <div class="addFollowMain">
                            ...
                            <li v-for="(text,index) in addQuestData.bankModels" :key="index">
                                ...
                                <div v-show="text.questionType=='RADIO'">
                                    ...
                                    <el-radio-group class="redioSingle redioSingleInput">
                                        <el-radio v-for="(text1,index1) in text.solutionModels" :key="index1"
                                            :label="index1">
                                            <span>{{text1.tag}}</span>
                                ...
                                <div v-show="text.questionType=='CHECKBOX'">
                                    ...
                                    <el-checkbox-group class="redioSingle redioSingleInput">
                                        <el-checkbox v-for="(text1,index1) in text.solutionModels" :key="index1"
                                            :label="index1">
                                            <span>{{text1.tag}}</span>
                                            <el-input class="" v-model="text1.answerDescribe" placeholder="请输入选项内容">
                                            </el-input>
                        ...
                        <div class="choiceItemBox">
                            <span :class="{'choiceItemBoxAtc':index2==questChoiceIndex}"
                                v-for="(text2,index2) in choiceItem" :key="index2"
                                @click="choiceItemFun(index2)">{{text2}}</span>
                        </div>
        ...
        <div v-if="followPlanVisible">
            <el-dialog class="evaluateBox addFollowBox addFollowBoxFollow" title=" " :visible.sync="followPlanVisible"
                width="602px" hight="356px" center>
        ...
        <div v-if="articleTableVisible">
            <el-dialog class="evaluateBox ArcticClass" title=" " :visible.sync="articleTableVisible" width="770px"
                hight="356px" center>
                <el-form ref="form" :model="addArticleData" label-width="80px">
                    ...
                    <el-form-item label="">
                        <el-select v-model="addArticleData.articleType" placeholder="请选择活动区域">
                            ...
                            <el-option v-for="(text1,index) in oTab14.list " :label="text1.text" :value="text1.value"
                                :key="index">
                    ...
                    <div class="addArticleImg">
                        <el-upload class="avatar-uploader" :action="articleImg" :show-file-list="false"
                            :on-success="articleImgSuccess">
                    ...
                    <div>
                        ...
                        <div class="addArticleEditor">
                            <quill-editor :disabled='quillDiabled' v-model="addArticleData.content" ref="myQuillEditor"
                                class="editer" :options="infoForm.editorOption" @ready="onEditorReady($event)"
                                @change="quillChange(addArticleData.content)">
                            </quill-editor>
                        </div>
                    </div>
                    <el-form-item label="">
                        <el-input class=" addArticleUrlClass" :disabled='urlDiabled' v-model="addArticleData.url"
                            placeholder="URL链接" @change="urlChange(addArticleData.url)"></el-input>
                    </el-form-item>
                    <div class="addFollowMain">
                        <div>
        ...
        <div class=" followDoc">
            <div>
                <ul class="titleTop">
                    <li v-for="(text,index) in followDocTab" :class="{'title-this':index==oDocThis}"
                        @click="docTab(index)" :key="index">{{text.name}}</li>
                </ul>
            </div>
    ...
    margin-left: 55px;' @timeValue="getDocTime"></publicTime>
                        ...
                        <el-button class="startConsul myStartConsul" v-show="docAddTemplate" type="text"
                            @click="docAddTemplateFun()">新增模板</el-button>
                    </div>
                    <div>
                        <div v-if="myFollowVisable" class="public-list">
                            <el-table :data="myFollowList" border style="width: 100%"
                                @selection-change="followCheckChange">
                                ...
                                <el-table-column prop="phoneFollowup" label="电话随访">
                                    <template slot-scope="scope">
                                        <el-switch v-model="scope.row.phoneFollowup" active-color="#13ce66"
                                            inactive-color="#ff4949" @change="phoneFollow(scope.row)">
                                        </el-switch>
                                    </template>
                                ...
                                <el-table-column prop="deviceAlert" label="设备告警">
                                    <template slot-scope="scope">
                                        <div class="warnNumBox">
                                            <el-switch v-model="scope.row.deviceAlert" active-color="#13ce66"
                                                inactive-color="#ff4949" @change="warnFollow(scope.row)">
                                            </el-switch>
                                ...
                                <el-table-column label="操作" width="250">
                                    <template slot-scope="scope">
                                        <el-button class='seeDanganClass' @click="seeDanganClick(scope.row)" type="text"
                                            size="small">查看档案</el-button>
                                        <el-button class='sendMessage' @click="sendMessage(scope.row)" type="text"
                                            size="small">发送</el-button>
                                        <el-button class='seeDetail' @click="myFollowDetail(scope.row)" type="text"
                                            size="small">查看详情</el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
                            <el-pagination style='text-align:center' background layout="prev, pager, next"
                                :total="adminTotal5" :current-change="changeCurrent5">
                            </el-pagination>
                            <div class="groupClass">
                                <div>移动到</div>
                                <ul>
                                    <li :class="oGroupClick==-1?'groupClick':''" @click="addGroup()">新增组</li>
                                    <li :class="oGroupClick==index?'groupClick':''" v-for="(item,index) in groupList"
                                        :key="index" @click="changeGroup(item.groupId,index)">
                                        {{item.groupName}}
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <tableList v-else :tableData="doctorList" :columns="doctorColumns"
                            :checkVisable="docTableChecked" :tableBtn="doctorBtn" :total="adminTotal4"
                            @rebackFenye="changeCurrent4"></tableList>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div v-if="followDetailVisible">
                <el-dialog class="evaluateBox addFollowBox  addFollowBoxFollow" title=" "
                    :visible.sync="followDetailVisible" width="602px" hight="356px" center>
