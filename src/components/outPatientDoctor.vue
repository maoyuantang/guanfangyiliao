			...
			<ul v-for="(text,index1) in myHomes" :key="index1" class="outpatient_s">
				<li class="outpatient_left">
					...
					<div class="outpatient_user">
						<img v-if="text.doctor[0].headId == null||!text.doctor[0].headId" src="../assets/img/doctorImg.png"
							alt="医生头像">
							...
							<el-form ref="form" label-width="80px">
								<div class="drugsCheckBox">
									...
									<el-form-item label="发病日期: ">
										<el-date-picker @blur="demonstration1" type="date" placeholder="选择日期" v-model="text.pb.occurTime"
											style="width: 100%;">
										</el-date-picker>
									</el-form-item>
									<el-form-item class="nextTimeClass" label="下次复查日期: ">
										<el-date-picker @blur="demonstration2" type="date" placeholder="选择日期" v-model="text.pb.occurTime"
											style="width: 100%;">
										</el-date-picker>
									</el-form-item>
								</div>
						...
						<div>
							<el-form ref="form" label-width="80px">
								<div class="drugsCheckBox">
									...
									<el-form-item class="nextTimeClass" label="下次复查日期: ">
										<el-date-picker @blur="demonstration2" type="date" placeholder="选择日期" v-model="text.pb.reviewTime"
											style="width: 100%;">
										</el-date-picker>
									</el-form-item>
								</div>
				...
				<ul v-for="(text5,index) in huanzheList" :key="index" class=""
					...
					<li class="name"
						...
						<div style="display: flex; align-items: center;">
							<img v-if="text5.headId == null||!text5.headId" style="width: 53px; margin: 0 30px 0 0;"
								src="../assets/img/a-6.png" alt="">
